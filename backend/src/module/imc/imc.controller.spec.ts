...
describe('ImcController', () => {
  ...
  it('deberia devolver IMC y categoria para un input valido', async () => {
    const dto: CalcularImcDto = { altura: 1.75, peso: 70 };
    const usuarioMock = { id: '1', usuario: 'testUser', email: 'test@example.com' }
  ...
  it('deberia tirar BadRequestException para input invalido', async () => {
  ...
  it('deberia devolver historial para query valida', async () => {
    const usuarioMock = { id: '1', usuario: 'testUser', email: 'test@example.com' };
  ...
  it('deberia generar 100 calculos con fechas random', async () => {
    const usuarioMock = { id: '1', usuario: 'testUser', email: 'test@example.com' };
    const resultadoMock = {
      id: '1',
      peso: 70,
