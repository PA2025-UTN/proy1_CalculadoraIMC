...
async function main() {
 ...
 if (!pgStats.connected) {
 console.log('1. PostgreSQL no est disponible. Verifica la conexión.');
 } else if (pgStats.userCount === 0) {
 console.log('1. Crea usuarios primero usando la API de registro.');
 } else if (pgStats.imcCount === 0) {
 console.log('1. Genera datos de prueba: npm run seed:postgres');
 console.log('2. Luego migra a MongoDB: npm run migrate:pg-to-mongo');
 } else if (!mongoStats.connected) {
 console.log('1. MongoDB no est disponible. Verifica la conexión.');
 } else if (mongoStats.imcCount === 0) {
 console.log('1. Listo para migrar: npm run migrate:pg-to-mongo');
 } else {
